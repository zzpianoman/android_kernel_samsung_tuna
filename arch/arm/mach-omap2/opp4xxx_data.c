...
#define OMAP4460_VDD_MPU_OPPNITROS_UV		1275000
#define OMAP4460_VDD_MPU_OPPNITROSB_UV		1350000
#define OMAP4460_VDD_MPU_OPPUBER_UV		1375000
...
/* NOTE: tuna and probably others don't want to play nicely with OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, work around that for now */
	...
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPP75_UV, 75000, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	...
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITROS_UV, 0, 0, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITROSB_UV, 0, 0, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPUBER_UV, 0, 0, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPFIRE_UV, 0, 0, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
#endif /* CONFIG_OMAP_SMARTREFLEX_CUSTOM_SENSOR */
#else
#ifdef CONFIG_OMAP_SMARTREFLEX_CUSTOM_SENSOR
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPP50_UV, 10000, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0, 0, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPP100_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP100, 0, 0, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	...
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
#endif /* CONFIG_OMAP_SMARTREFLEX_CUSTOM_SENSOR */
#endif /* CONFIG_OMAP4460_OVERCLOCKING */
};
